<?php
    ...
    
    {
        ...
        //query statement
        $sql = "UPDATE `productsales` SET PricePromotion=$pricePromotion WHERE ProductSalesID = $productSalesID";
        ...
        $sql = "select * from productsales where ProductSalesID = $productSalesID";
