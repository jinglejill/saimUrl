<?php
    ...
    include_once('SAIM_TEST/dbConnect.php');
...
<body>
<form id="myForm" action="createQRCodeFileTesting.php" method="post">
<?php
...
//    if($_REQUEST["create"])
    ...
    ?>
<tr><td>
<input type="submit" value="Create QR Code File" name="create" id="create" >
</td></tr>
</table>
</form>
</body>
