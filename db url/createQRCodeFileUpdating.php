<?php
    ...
    include_once('SAIM_UPDATING/dbConnect.php');
...
<body>
<form id="myForm" action="createQRCodeFile.php" method="post">
<?php
    ...
    if($validate == 1 && $_POST["create"])
    {
        ...
        for($k=1; $k<=$rowCount; $k++)
        {
            ...
            for($i=1; $i<=$quantity; $i++)
            {
                ...
                //                $code = $_POST["productName".$r02].$_POST["color".$r02].$_POST["size".$r02].$_POST["manufacturingDate".$r02] . sprintf("%06d", $maxProductID + $i);
