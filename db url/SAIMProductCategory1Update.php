<?php
    ...
    
    {
        ...
        {
            //query statement
            $sql = "UPDATE `productcategory1` SET name='$name[$i]' WHERE productcategory2='$productCategory2[$i]' AND code = '$code[$i]'";
            ...
            $sql = "select * from productcategory1 where productcategory2='$productCategory2[$i]' AND code = '$code[$i]'";
